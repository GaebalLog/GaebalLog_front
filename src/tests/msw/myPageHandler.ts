...
export const myPageHandler = [
  ...
  // 글 관리
  rest.get("/api/post/previews?type=me", (req, res, ctx) => {
    const posts: posts = [
      {
        postId: 1,
        title: "내가 쓴 글1",
  ...
  //   return res(ctx.status(200), ctx.json({ posts }));
  // }),
  rest.get("/api/post/previews?type=bookmark", (req, res, ctx) => {
    const posts: posts = [
      {
        postId: 1,
        title: "내가 북마크한 글1",
  ...
  rest.get("/api/post/previews?type=comment", (req, res, ctx) => {
    const posts: posts = [
      {
        postId: 1,
        title: "내가 댓글 단 글1",
  ...
  rest.get("/api/post/previews?type=like", (req, res, ctx) => {
    const posts: posts = [
      {
        postId: 1,
        title: "내가 좋아요 한 글1",
  ...
  // 이웃 관리
  rest.get("/api/users/neighbors/following/:id", (req, res, ctx) => {
    const neighbors = [
      {
        userId: 1,
        nickname: "내가 추가한 이웃1",
